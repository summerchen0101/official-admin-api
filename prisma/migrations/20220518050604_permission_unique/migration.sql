/*
  ...
  - A unique constraint covering the columns `[controller,handler]` on the table `Permission` will be added. If there are existing duplicate values, this will fail.
